<template>
        <svg id="Layer_1" x="0px" y="0px" viewBox="0 0 28.4 28.4" xml:space="preserve" class="sc-AxgMl iRruVi app-logo">
            <g>
                <path
...
<style>
    ...
    svg {
        height: 120px;
        width: 120px;
        fill: rgb(142, 158, 172);
        opacity: 0.5;
        pointer-events: none;
        animation: 10s linear 0s infinite normal none running mymove;
    }
